...
map.getView().fit([12462969.591192, -876484.750028, 12473613.719965, -869981.152210], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">HALTE FOTO NATHA</h2>';
        return titleElement;
    })(),
